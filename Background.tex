...
\begin{figure}[htb]
  \centering
  \framebox[6.5in]{Minard plot of bandwidths.}
...
\begin{figure}
  ...
  \subfloat
      ...
      {
        \framebox[.98\linewidth]{[Science Code] --Simulation Data--$>$ [Persistent
            Storage]}
...
\fix{Ken is ready to remove this file as soon as the replacement figures
  are made.}
