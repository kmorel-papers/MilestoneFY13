...
% These are mandatory
%
\SANDnum{SAND2013-1122} % e.g. \SANDnum{SAND2006-0420}
\SANDprintDate{November 2013} % Month, year
...
\includepdf[scale=0.9,pagecommand={\section{Signed Letter from Committee}}]{figures/MilestoneApprovalLetter}

\includepdf[pages=1,pagecommand={\section{Executive Summary Slides}}]{Summary/SummarySlides}
\includepdf[pages=2-,pagecommand={}]{Summary/SummarySlides}
