...
important \insitu and \intransit operations for the 8k-core
experiments.  In each plot, we gathered data from five separate 500-cycle
experiments.
...
One way to get a good understanding of the scalability of an operation is to
look at the throughput or processing rate.  In this case, we look at the rate
the analysis operation processes blocks as we increase the number of client
cores.
...
Figure~\ref{fig:processing-rates} shows the processing rates
