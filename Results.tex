...
important \insitu and \intransit operations at 10-cycle increments of the 8k
run.  In each plot, we gathered data from five separate 500-cycle experiments.
...
standard error for CTH and the \insitu analysis operations at each 10-cycle
section of five 500-cycle experiments for 8K cores using the 1.5m data blocks
data set.}
...
standard error for the \intransit transfer and wait operations at each 10-cycle
section of five 500-cycle experiments for 8K cores using the 1.5m data blocks
data set.}
